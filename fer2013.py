...
tf.app.flags.DEFINE_integer('batch_input_size', 128,
                            """Number of images to process in a batch.""") # TODO: might change!

tf.app.flags.DEFINE_string('data_input_dir', '/tmp/fer2013_data',
                           """Path to the FER2013 data directory.""")
