  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      while step < num_iter and not coord.should_stop():
        ...
        print("-----------------------------------------------------")
        print('LABEL FOR INPUT IMAGE:', result2[0], '->', emotion_dict[result2[0]],'result1',result1[0])
        print("-----------------------------------------------------")
        step += 1
        #break
      ...
      # Compute precision @ 1.
      precision = true_count / total_sample_count #step
      print('Summary -- Step:', step, 'Accuracy:',true_count / step * 1.0, )
